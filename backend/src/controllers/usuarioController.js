//info: Valida campos obligatorios (nombre, tipo_documento, documento, placa), verifica que la placa exista, busca celda disponible, registra usuario y la ocupa. Al desactivar, libera la celda.
